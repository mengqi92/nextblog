...
它的函数图像：
![逻辑回归函数图像](https://blog.mengqi.life/images/logistic-regression/Logistic-curve.png)
...
![非凸函数和凸函数](https://blog.mengqi.life/images/logistic-regression/convex-function.png)
...
![损失函数](https://blog.mengqi.life/images/logistic-regression/cost-function.png)
